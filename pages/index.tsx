      ...
      <main className="min-h-screen bg-gray-950 text-white">
        ...
        <section className="flex flex-col items-center justify-center text-center py-32 px-6">
          ...
          <p className="max-w-2xl text-gray-300">
            Je conçois et développe des applications performantes et évolutives, avec une vision architecturale des systèmes d’information.
          </p>
          <a
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-gray-800 p-6 rounded-xl hover:scale-105 transition">
                ...
                <p className="text-gray-400">Application web</p>
              </div>
              <div className="bg-gray-800 p-6 rounded-xl hover:scale-105 transition">
                <h4 className="text-xl font-semibold mb-2">Flutter</h4>
                <p className="text-gray-400">Applications Flutter</p>
              </div>
              <div className="bg-gray-800 p-6 rounded-xl">
                <h4 className="text-xl font-semibold mb-2">Autres Projets</h4>
                <p className="text-gray-400">Futur projet...</p>
              </div>
            </div>
          </div>
        </section>
